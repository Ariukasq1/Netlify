...
import { INDUSTRY_PRICE_FEAUTURES , FEATURES, TITLES, SLOGANS, SHORT_DESC, PAGE_DESC } from "./constant"; "./[detail]"
class SolutionDetail extends Component {
  ...
  renderSingleFeature( data, i){
    if( i%2 === 0 ){
      return(
        <div className="row flex-center single-feature-box" style={{overflowY:"hidden"}}>
        <div className="col-lg-6 order-lg-last">
          <div className="text-wrapper">
            ...
            <p>{data.desc}</p>
            <ul className='mt-30'>
            {data.list.map( el => <li key={el.toString()}>{el}</li>)}
            </ul>
          </div>
          </div>
      ...
      <Layout forms={[{ brand_id: "m7DmKt", form_id: "4uBFnr",},]} >
          ...
          <div className="container">
              ...
              <div className="centered-img" >
                <img src={ slug==="hr" ? "../images/hr/First.png" :   slug==="marketing" ? "../images/marketing/info.png" : ""} />
              </div>
          </div>
              </div>
          </div>

        <div className="our-feature-app p0" style={{overflowY:"hidden"}}>
          { FEATURES[slug] && FEATURES[slug].map( (el, i) => this.renderSingleFeature(el, i))}
        </div>
